...
export default function CampaignBuilder({ mode, campaignId }: CampaignBuilderProps) {
  ...
  useEffect(() => {
    // The lightweight accounts endpoint, not the analytics aggregation: the
    // builder is gated on this before it can render, and none of the stats
    // were ever read here.
      ...
      <div className="flex flex-wrap items-center justify-between gap-x-4 gap-y-3">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <button
            ...
            disabled={saving}
            className="rounded-lg bg-accent px-5 py-2 text-sm font-medium text-foreground hover:bg-accent-hover disabled:opacity-50"
          >
