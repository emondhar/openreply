    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="border-y border-border bg-surface py-16">
        <div className="mx-auto w-full max-w-7xl px-5 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 overflow-hidden border border-border">
            <div className="grid grid-cols-[0.8fr_1fr_1fr] border-b border-border bg-background text-xs font-bold uppercase tracking-wide text-muted">
              <div className="p-4">Need</div>
              <div className="p-4 text-accent-strong">OpenReply</div>
      ...
      <section className="mx-auto w-full max-w-7xl px-5 py-16 sm:px-6 lg:px-8">
        <div className="border border-cyan-200/20 bg-cyan-300/10 p-8 text-center">
          ...
          <Link
            href="/login"
            className="mt-8 inline-flex items-center justify-center bg-cyan-300 px-6 py-3 text-sm font-bold text-foreground transition hover:bg-cyan-200"
          >
            Start free
          </Link>
        </div>
