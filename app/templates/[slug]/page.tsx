            ...
            <ol className="mt-5 space-y-3">
              {template.playbook.map((step, index) => (
                <li key={step} className="grid gap-3 sm:grid-cols-[40px_1fr]">
                  <span className="flex h-8 w-8 items-center justify-center bg-cyan-300 text-sm font-black text-foreground">
                    {index + 1}
                  </span>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            {relatedTemplates.map((item) => (
              <Link
                ...
                className="border border-border bg-surface p-5 transition hover:border-border hover:bg-surface"
              >
