          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            ...
            <div className="border border-border bg-surface p-4 text-sm text-muted md:min-w-64">
              ...
              {report.branded && (
                <Link
                  href="/"
                  className="mt-4 inline-flex items-center justify-center border border-cyan-200/20 bg-cyan-300/10 px-3 py-2 text-xs font-semibold text-accent-strong transition hover:border-cyan-200/40"
                >
            ...
            <div>
              ...
              {report.campaign.postUrl ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-3 inline-flex text-sm font-semibold text-cyan-200 transition hover:text-accent-strong"
                >
                  View Instagram post
                </a>
              ) : (
